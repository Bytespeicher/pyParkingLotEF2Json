...
static_data = []
static_data.append({ 'latitude':"50.9725714", 'longitude':"11.0338341" , 'adresse':"Thomasstraße, 99084 Erfurt"})
static_data.append({ 'latitude':"50.9843184", 'longitude':"11.0311626" , 'adresse':"Wallstraße, 99084 Erfurt"})
static_data.append({ 'latitude':"50.97828", 'longitude':"11.02073" , 'adresse':"Bechtheimer Straße 1, 99084 Erfurt"})
...
static_data.append({ 'latitude':"50.970866", 'longitude':"11.018662" , 'adresse':"Bonifaciusstraße 15, 99084 Erfurt"})
...
class ParkingLotEF2Json():
    ...
    def getJson(self):
        ...
        for elem in m:
            name = re.search(r'"[ A-Za-z0-9äöü+-]+"', elem, re.UNICODE).group(0)[1:-1]
